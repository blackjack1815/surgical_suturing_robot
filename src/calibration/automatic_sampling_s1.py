...
def sampling_3(st_config_fname, es_config_fname, serial_num):
    """

    :param st_config_fname: {string} -- the .csv file name of the standard configuration
    :param es_config_fname: {string} -- the .csv file name of the seed configuration
    ...
    robot = world.robot(0)
    Clink_set = sample_conf_true(st_config_fname)
    origin_config = sample_conf_true(es_config_fname)
    est_config_list = gen_est_config_list(robot, Clink_set, origin_config[0])
    ...
    df.to_csv("../../data/robot_configuration_files/configuration_record_" + serial_num + "B.csv",
...
if __name__ == "__main__":
    ...
    sampling_3(st_config_name, es_config_name, serial_num)
